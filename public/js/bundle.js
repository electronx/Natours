      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Please Scan the QR code');
              window.setTimeout(function () {
...
var qrVerifyForm = document.querySelector('.form--verify'); // DELEGATION
